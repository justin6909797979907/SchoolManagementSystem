...
//    const addSchoolYearModal = new bootstrap.Modal(document.getElementById('addSchoolYearModal'));
    ...
    */
    ...
    if (e.target.classList.contains("view-btn")) {
        ...
        const enrollee_id = e.target.dataset.id;

         window.open(
        `${BASE_URL}/enrollees/${enrollee_id}/show`,
        "_blank"
        );
    ...
    */
    ...
    fetch(`${BASE_URL}/enrollees/all?order=${order}&limit=${limit}&page=${page}&search=${encodeURIComponent(search)}`)
        ...
        .then(result => {
            ...
            result.data.forEach((enrollee,index)=> {
                tbody.innerHTML += `
                    <tr class="activity-row">

                     <td><input type="checkbox" class="activity-checkbox" value="${enrollee.id}"></td>
                        <td>${enrollee.application_number}</td>
                        <td>${enrollee.first_name} ${enrollee.surname}</td>
                        <td>${enrollee.email}</td>
                        <td>${enrollee.submitted_at}</td>
                         <td>
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
            <li>
              <button class="dropdown-item view-btn" data-id="${enrollee.id}" type="button">
                    View Details
                </button>
            </li>
