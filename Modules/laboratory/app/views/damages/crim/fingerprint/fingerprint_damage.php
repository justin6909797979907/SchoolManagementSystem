        ...
        <div class="card mb-4 card shadow-sm border-0 border-top border-4 border-secondary shadow-lg p-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button
                    ...
                    data-bs-target="#fpAddDamageModal">
                    <i class="fas fa-plus me-1"></i> Create New
                </button>
            </div>
            <div class="card-body">
                <table id="fpDamageTable" class="table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Item Name</th>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <button
                                                class="dropdown-item"
                                                data-bs-toggle="modal"
                                                data-bs-target="#fpViewDamageModal">
                                        ...
                                        <li>
                                            <button
                                                class="dropdown-item"
                                                data-bs-toggle="modal"
                                                data-bs-target="#fpEditDamageModal">
...
<?php require __DIR__ . '/fpAddDamageModal.php'; ?>
<?php require __DIR__ . '/fpEditDamageModal.php'; ?>
<?php require __DIR__ . '/fpViewDamageModal.php'; ?>
