        ...
        <div class="card mb-4 card shadow-sm border-0 border-top border-4 border-secondary shadow-lg p-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button
                    ...
                    data-bs-target="#fpAddMonitoringModal">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <button
                                                class="dropdown-item"
                                                data-bs-toggle="modal"
                                                data-bs-target="#fpViewMonitoringModal">
                                        ...
                                        <li>
                                            <button
                                                class="dropdown-item"
                                                data-bs-toggle="modal"
                                                data-bs-target="#fpEditMonitoringModal">
...
<?php require __DIR__ . '/fpAddMonitoringModal.php'; ?>
<?php require __DIR__ . '/fpViewMonitoringModal.php'; ?>
<?php require __DIR__ . '/fpEditMonitoringModal.php'; ?>
