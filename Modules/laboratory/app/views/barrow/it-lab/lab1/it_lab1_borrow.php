        ...
        <div class="card mb-4 card shadow-sm border-0 border-top border-4 border-secondary shadow-lg p-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button
                    ...
                    data-bs-target="#lab1AddBorrowModal">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <button
                                                class="dropdown-item"
                                                data-bs-toggle="modal"
                                                data-bs-target="#lab1ViewBorrowModal">
                                        ...
                                        <li>
                                            <button
                                                class="dropdown-item"
                                                data-bs-toggle="modal"
                                                data-bs-target="#lab1EditBorrowModal">
...
<?php require __DIR__ . '/lab1AddBorrowModal.php'; ?>
<?php require __DIR__ . '/lab1ViewBorrowModal.php'; ?>
<?php require __DIR__ . '/lab1EditBorrowModal.php'; ?>
