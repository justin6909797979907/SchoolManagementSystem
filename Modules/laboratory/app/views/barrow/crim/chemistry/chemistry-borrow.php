        ...
        <div class="card mb-4 card shadow-sm border-0 border-top border-4 border-secondary shadow-lg p-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button
                    ...
                    data-bs-target="#chemAddBorrowModal">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <button
                                                class="dropdown-item"
                                                data-bs-toggle="modal"
                                                data-bs-target="#chemViewBorrowModal">
                                        ...
                                        <li>
                                            <button
                                                class="dropdown-item"
                                                data-bs-toggle="modal"
                                                data-bs-target="#chemEditBorrowModal">
...
<?php require __DIR__ . '/chemAddBorrowModal.php'; ?>
<?php require __DIR__ . '/chemViewBorrowModal.php'; ?>
<?php require __DIR__ . '/chemEditBorrowModal.php'; ?>
