        ...
        <div class="card mb-4 card shadow-sm border-0 border-top border-4 border-secondary shadow-lg p-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button
                    ...
                    data-bs-target="#dtAddBorrowModal">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <button
                                                class="dropdown-item"
                                                data-bs-toggle="modal"
                                                data-bs-target="#dtViewBorrowModal">
                                        ...
                                        <li>
                                            <button
                                                class="dropdown-item"
                                                data-bs-toggle="modal"
                                                data-bs-target="#dtEditBorrowModal">
...
<?php require __DIR__ . '/dtAddBorrowModal.php'; ?>
<?php require __DIR__ . '/dtViewBorrowModal.php'; ?>
<?php require __DIR__ . '/dtEditBorrowModal.php'; ?>
